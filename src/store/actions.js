...
const actions = {
  ...
  setViewTrano: ({commit}, newVal) => {
    commit('setViewtrano', newVal);
  },
  ...
  getHotelPriceSearch: ({commit}, hotelId) => {
    ...
    vue.$http.get('http://route.showapi.com/405-8', {params: {hotelId: hotelId, comeDate: '20171010', leaveDate: '20171011', showapi_sign: '4e1311ce4fd04c7bb8c75c49fb75ed71', showapi_appid: '47232'}}).then(response => {
